...
def filter_irrelevant_info(text):
    ...
    greeting_words = {
        'здравствуйте', "здравствуй", 'привет', "приветствую", 'добрый', 'день', 'утро', 'вечер', "ночь"
    }
    ...
    request_verbs = {
        'хотеть', 'просить', 'помогать', 'надо', 'нужно', 'требовать', 'просьба', 'возможность', "необходимо", "мочь"
    }
    roles = {
        'hr', 'дм', 'менеджер', 'руководитель', 'специалист', 'сотрудник', 'работник',
        'директор', 'начальник', 'администратор'
    }
    profanity = {
